...
// ===============================================================
// 5. RECENT SUBMISSIONS (DETAILED + CATEGORY)
// ===============================================================

// @desc Detailed recent task submissions
...
exports.getRecentSubmissions = async (req, res, next) => {
  try {
    ...
    let query = {};
    if (status) query['submissions.status'] = status;
    ...
    const paged = submissions.slice((page - 1) * limit, page * limit);
