...
router.get('/announcements/:id', protect, authorize('admin'), adminController.getAnnouncementDetail);
router.post('/announcements', protect, authorize('admin'), adminController.createAnnouncement);
router.put('/announcements/:id', protect, authorize('admin'), adminController.updateAnnouncement);
router.delete('/announcements/:id', protect, authorize('admin'), adminController.deleteAnnouncement);
